						...
						<div class='card_customized_goods'>
							...
							<div class="btn_share">
							 ...
							 <span class="share_box">
								 <img @click="toShare('https://weixin.qq.com/')" src="/img/wx_icon.png" alt="">
								 <img @click="toShare('https://weixin.qq.com/')" src="/img/friend_icon.png" alt="">
								 <img @click="toShare('https://im.qq.com/')" src="/img/qq_icon.png" alt="">
								 <img @click="toShare('https://qzone.qq.com/')" src="/img/qq_space.png" alt="">
								 <img @click="toShare('https://weibo.com/')" src="/img/wb_icon.png" alt="">
								 <img @click="toShare('https://douyin.com/')" src="/img/tiktok_icon.png" alt="">
							 </span>
							</div>
